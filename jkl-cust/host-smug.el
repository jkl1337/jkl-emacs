...
(eval-after-load "emms"
  '(progn
     ...
     (jkl/cs 'emms-player-list (cons 'emms-player-mpd emms-player-list)
             'emms-player-mpd-connect-function 'jkl/mpd-local-connect
             'emms-volume-change-function 'emms-volume-mpd-change
             'emms-player-mpd-music-directory "~/music"
             'emms-player-mpd-server-name nil
             'emms-player-mpd-server-port "/home/luebsj/.mpd/socket")

     (jkl/cs 'emms-player-mpd-supported-regexp
